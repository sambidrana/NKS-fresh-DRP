...
export default function Nav(prop) {
  ...
  return (
    <aside className={(show ? 'left-0' : '-left-full')+" top-0 text-gray-700 p-4 fixed w-full bg-bgGray h-full md:static md:w-auto transition-all"}>
     <div className="mb-4 mr-2">
      <Logo />
     </div>
      <nav className="flex flex-col gap-2">
        <Link onClick={navToggle} href={'/'} className={pathname === '/' ? activeLink : inactiveLink}>
        ...
        <Link onClick={navToggle} href={'/products'} className={pathname.includes('/products') ? activeLink : inactiveLink}>
        ...
        <Link onClick={navToggle} href={'/categories'} className={pathname.includes('/categories') ? activeLink : inactiveLink}>
        ...
        <Link onClick={navToggle} href={'/orders'} className={pathname.includes('/orders') ? activeLink : inactiveLink}>
        ...
        <Link onClick={navToggle} href={'/settings'} className={pathname.includes('/settings') ? activeLink : inactiveLink}>
